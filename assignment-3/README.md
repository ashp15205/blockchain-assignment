...
# Create .env.local with your Supabase and contract keys
npm run dev
...
## 📸 Screenshots
*(Attach screenshots of: MetaMask wallet connection popup, Connected wallet address shown in navbar, Staking transaction confirmation in MetaMask, Match result with payout)*
